<template>
  <div class="header">
    ...
    <div class="header__menu">
      <svg class="menu--svg" xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
...
@media (max-width: 1000px) {
  ...
  .header__menu svg:nth-child(1),
  .header__menu svg:nth-child(2) {
    display: none;
  }
